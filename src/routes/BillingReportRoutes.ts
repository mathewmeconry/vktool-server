...
export default function BillingReportRoutes(app: Express.Application) {
    ...
    app.post('/api/billing-reports/approve', AuthService.checkAuthorization([AuthRoles.BILLINGREPORTS_APPROVE]), BillingReportController.approveDecline)
    app.post('/api/billing-reports/decline', AuthService.checkAuthorization([AuthRoles.BILLINGREPORTS_APPROVE]), BillingReportController.approveDecline)
