...
export class warehouse1600646508394 implements MigrationInterface {
    name = 'warehouse1600646508394'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `product` (`id` int NOT NULL AUTO_INCREMENT, `updatedAt` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `bexioId` int NOT NULL, `articleType` int NOT NULL, `delivererCode` text NULL, `delivererName` text NULL, `delivererDescription` text NULL, `internCode` varchar(255) NOT NULL, `internName` varchar(255) NOT NULL, `internDescription` text NULL, `purchasePrice` float NULL, `salePrice` float NULL, `purchaseTotal` float NULL, `saleTotal` float NULL, `remarks` text NULL, `deliveryPrice` float NULL, `articleGroupId` int NULL, `weight` float NULL, `contactId` int NULL, INDEX `idx_bexioId` (`bexioId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `product` ADD CONSTRAINT `FK_6e261c5766f871875869f7443cb` FOREIGN KEY (`contactId`) REFERENCES `contact`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `product` DROP FOREIGN KEY `FK_6e261c5766f871875869f7443cb`");
        ...
        await queryRunner.query("DROP INDEX `idx_bexioId` ON `product`");
