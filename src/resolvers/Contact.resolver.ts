import PaginatedResponse, { createResolver, resolveEntity, resolveEntityArray, PaginationArgs } from "./helpers"
...
export default class ContactResolver extends baseResolver {
    ...
    @FieldResolver()
    public async compensations(@Root() object: Contact): Promise<Array<OrderCompensation | CustomCompensation>> {
