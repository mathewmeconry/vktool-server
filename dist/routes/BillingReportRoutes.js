...
function BillingReportRoutes(app) {
    app.get('/api/billing-reports', AuthService_1.default.checkAuthorization(AuthRoles_1.AuthRoles.BILLINGREPORTS_READ), BillingReportController_1.default.getBillingReports);
    app.get('/api/billing-reports/open', AuthService_1.default.checkAuthorization(AuthRoles_1.AuthRoles.BILLINGREPORTS_READ), BillingReportController_1.default.getOpenOrders);
    app.post('/api/billing-reports/approve', AuthService_1.default.checkAuthorization(AuthRoles_1.AuthRoles.BILLINGREPORTS_EDIT), BillingReportController_1.default.approve);
